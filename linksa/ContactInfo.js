    ...
    return (
	   <View style={{flex:1,flexDirection:'column',}}>
           <View style={styles.card}>
				...
				<View style={{flex:1,flexDirection:'column',backgroundColor:'#ececec'}}>
				    <View style={{height:150,flexDirection:'column',backgroundColor:'#4385f4',alignItems:'center',paddingBottom:40, }}>
					   ...
					   <View style={{flexDirection:'row',alignItems:'center',justifyContent:'center',marginTop:100,}}>
					      <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#fff',fontSize:18,}}>{ this.props.id }</Text>
					   </View>   
					</View>
					<ScrollView>
					<View style={{backgroundColor:'#fff',marginTop:10,paddingLeft:20,flexDirection:'column',}}>
					   <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{paddingTop:15,paddingBottom:15, color:'#4385f4',}}>联系方式</Text>
					   <View style={{flexDirection:'row', borderBottomWidth:0.5, borderColor:'#dadada',height:50,alignItems:'center',}}>
						   ...
						   <View style={{flex:1,marginLeft:20,flexDirection:'row',justifyContent:'center',alignItems:'center',}} >
							  ...
							  <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:14,flex:1,}} allowFontScaling={false}>{this.state.datas.email}</Text>
							  <TouchableOpacity  
							      activeOpacity={0.5}  
					   ...
					   <View style={{flexDirection:'row', borderBottomWidth:0.5, borderColor:'#dadada',height:50,alignItems:'center',}}>
						   ...
						   {this.state.datas.phone ? <View style={{flex:1,marginLeft:20, flexDirection:'row',justifyContent:'center',alignItems:'center',}}>
							  <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{flex:1,}}>{this.state.datas.phone}</Text>
							  <TouchableOpacity  
							      activeOpacity={0.5}  
					    ...
					    <View style={{flexDirection:'row', height:50,alignItems:'center',}}>
                           ...
                           {this.state.datas.mobile ? <View style={{flex:1,marginLeft:20, flexDirection:'row',justifyContent:'center',alignItems:'center',}}>
							  <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{flex:1,}}>{this.state.datas.mobile}</Text>
							  <TouchableOpacity  
							      activeOpacity={0.5}  
					...
					<View style={{backgroundColor:'#fff',marginTop:10,paddingLeft:20,flexDirection:'column',}}>
					   <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{paddingTop:15,paddingBottom:15, color:'#4385f4',}}>部门职位</Text>
					   <View style={{flexDirection:'row', borderBottomWidth:0.5, borderColor:'#dadada',height:50,alignItems:'center',}}>
						   <View>
			   ...
			   <Animated.View style={{flexDirection:'row',ZIndex:100000,position:'absolute',top:50,left:(Dimensions.get('window').width-80)/2,alignItems:'center',justifyContent:'center',height:80,width:80,borderRadius:40, backgroundColor:'transparent',transform:[{translateY:this.state.trans.y},{translateX:this.state.trans.x} ],}} {...this._panResponder.panHandlers}>
