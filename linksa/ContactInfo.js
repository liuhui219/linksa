	   ...
	   <View style={{flex:1,flexDirection:'column',}}>
           <View style={styles.card}>
				...
				<View style={{flex:1,flexDirection:'column',backgroundColor:'#ececec'}}>
					...
					<View style={{backgroundColor:'#fff',marginTop:10,paddingLeft:20,flexDirection:'column',}}>
					   <Text style={{paddingTop:15,paddingBottom:15, color:'#4385f4',}}>部门职位</Text>
					   <View style={{flexDirection:'row', borderBottomWidth:0.5, borderColor:'#dadada',height:50,alignItems:'center',}}>
						   <View>
							  <Text style={{ color:'#999',}}>所在部门：</Text>   
						   </View>     
						   <View style={{flex:1,marginLeft:20, }}>
							  <Text>{this.state.datas.deptName}</Text>
						   </View>
					   </View>
					   <View style={{flexDirection:'row', height:50,alignItems:'center',}}>
						   <View>
							  <Text style={{ color:'#999',}}>职位名称：</Text>   
						   </View>     
						   <View style={{flex:1,marginLeft:20,}}>
							  <Text>{this.state.datas.postName}</Text>
						   </View>
					   </View> 
					</View>
				  </ScrollView>
