    ...
    render() {
      ...
      <View style={{flex:1,flexDirection:'column',}}>
         <View style={{borderColor:'#ccc',borderWidth:1,backgroundColor:'#ddd',height:50,flexDirection:'row',alignItems:'center'}}>
           ...
           />
         <Animated.View style={{width:this.state.width,justifyContent:'center',alignItems:'center',overflow:'hidden'}}><Text onPress={this.cancer.bind(this)} allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:16,color:'#4385f4',}}>取消</Text></Animated.View>
         </View>
    		 <ListView
